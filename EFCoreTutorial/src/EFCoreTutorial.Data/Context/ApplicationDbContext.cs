...
using static EFCoreTutorial.Data.Models.Book;
...
namespace EFCoreTutorial.Data.Context
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //db'e bağlandığı kısım
                optionsBuilder.UseSqlServer("Data Source=HASENEK;Initial Catalog=efcore;Persist Security Info=True;User ID=sa;Password=hasenek;Trust Server Certificate=True");
            }
        }
        //database'e tablo oluşturup özellikleri belirtiyoruz
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                ...
                entity.Property(i => i.FirstName).HasColumnName("first_name").HasColumnType("nvarchar").HasMaxLength(200);
                entity.Property(i => i.LastName).HasColumnName("last_name").HasColumnType("nvarchar").HasMaxLength(200);
